"""Tests for the main BrowseGenie class"""
...
class TestBrowseGenie:
    """Test cases for BrowseGenie class"""
    ...
    def test_init_default_params(self):
        """Test BrowseGenie initialization with default parameters"""
    ...
    def test_init_custom_params(self):
        """Test BrowseGenie initialization with custom parameters"""
        with patch.dict(os.environ, {"GEMINI_API_KEY": "test_key"}):
            scraper = BrowseGenie(
                api_key="test_key",
    ...
    def test_logging_setup(self):
        ...
        with patch.dict(os.environ, {"GEMINI_API_KEY": "test_key"}):
            scraper = BrowseGenie(temp_dir=self.temp_dir)
...
class TestBrowseGenieMethods:
    """Test cases for BrowseGenie methods"""
    ...
    def test_string_representation(self):
        """Test string representation of BrowseGenie"""
        with patch.dict(os.environ, {"GEMINI_API_KEY": "test_key"}):
            scraper = BrowseGenie(temp_dir=self.temp_dir)
